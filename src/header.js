...
import bigHome from "./assets/img/icons/big-home.svg";
import bigPhone from "./assets/img/icons/big-phone.svg";
import bigLogIn from "./assets/img/icons/big-log-in.svg";
...
const loadProtectingMenu = (globalMenuSelected) => {
  if (globalMenuSelected === "advisors") {
    return (
      <div className="dropdown-menu">
        <a
          ...
          href="https://lipartners.adityabirlacapital.com/New/"
        >
          Life Insurance Advisors
        </a>
        <a
          className="dropdown-item"
          href="https://www.adityabirlacapital.com/healthinsurance/#!/advisors-councel"
        >
    ...
    return (
      <div className="dropdown-menu">
        <a href="https://corporategeneralinsurance.adityabirlacapital.com/products/overview">
          Corporate General Insurance{" "}
        </a>
        <a href="https://lifeinsurance.adityabirlacapital.com/group-insurance/overview">
          Group Life Insurance{" "}
        </a>
        <a href="https://www.adityabirlacapital.com/healthinsurance/#!/group-health-insurance-products">
  ...
  if (globalMenuSelected === "advisors") {
    return (
      <div className="dropdown-menu">
        <a
          className="dropdown-item"
          href="https://mf.adityabirlacapital.com/Pages/Advisor/Advisor-Portal.aspx"
        >
          Mutual Funds Advisors{" "}
        </a>
        <a
          className="dropdown-item"
          href="https://stocksandsecurities.adityabirlacapital.com/partner"
        >
    ...
    return (
      <div className="dropdown-menu">
        <a href="https://privateequity.adityabirlacapital.com/Pages/Individual/Funds-Under-Management/Overview.aspx">
          Private Equity{" "}
        </a>
        <a href="https://mutualfund.adityabirlacapital.com/investor-solution-corporate">
          Mutual Funds{" "}
        </a>
        <a href="https://stocksandsecurities.adityabirlacapital.com/">
          Stock and Securities{" "}
        </a>
        <a href="https://portfoliomanagementservices.adityabirlacapital.com/">
          Portfolio Management Services{" "}
        </a>
  ...
  if (globalMenuSelected === "advisors") {
    return (
      <div className="dropdown-menu">
        <a
          className="dropdown-item"
          href="https://abfl.adityabirlacapital.com/partners/"
        >
          Financing Advisors
        </a>
      </div>
    ...
    return (
      <div className="dropdown-menu">
        <a href="https://corporatefinance.adityabirlacapital.com/Pages/Individual/Products/Overview.aspx">
          Corporate Finance
        </a>
        <a href="https://mortgagefinance.adityabirlacapital.com/Pages/Individual/Products/Overview.aspx">
          Mortgage Finance{" "}
        </a>
        <a href="https://loanagainstsecurities.adityabirlacapital.com/Pages/Individual/Products/Overview.aspx">
          Loans Against Securities{" "}
        </a>
        <a href="https://dcmandsyndication.adityabirlacapital.com/Pages/Individual/Products/Overview.aspx">
  ...
  if (globalMenuSelected === "advisors") {
    return (
      <div className="dropdown-menu">
        <a
          className="dropdown-item"
          href="https://www.abcselect.adityabirlacapital.com/?ref=abc-homepage"
        >
          Select Advisor
        </a>
      </div>
    ...
    return (
      <div className="dropdown-menu">
        <a href="https://advising.adityabirlacapital.com/money-for-life-planner">
          MoneyforLife Planner{" "}
        </a>
        <a href="https://www.adityabirlacapital.com/abc-of-money">
          ABC of Money{" "}
        </a>
      </div>
    );
        ...
        <div className="top-bg pull-right">
          <ul className="nav header-dropdown" id="header-dropdown">
            <li id="personal-topmenu" className="scnd_center">
              ...
              <ul
                className="dropdown-menu global-nav-dropdown-menu"
                id="corporate-childmenu"
              >
                <ul className="col-section-container">
                  <li className="level1 pink-link-section">
                    ...
                    <ul className="list-unstyled">
                      ...
                      <li className="level2">
                        <a href="https://www.adityabirlacapital.com/multiply-wellness/#!/home">
                          Multiply Welness
                        </a>
                      </li>
                      <li className="level2">
                        <a href="https://motorinsurance.adityabirlacapital.com/Pages/Individual/Products/Motor-Insurance.aspx">
                          Motor Insurance
                        </a>
                      </li>
                      <li className="level2">
                        <a href="https://travelinsurance.adityabirlacapital.com/Pages/Individual/Products/Overseas-Travel.aspx">
                          Travel Insurance
                        </a>
                      </li>
                    </ul>
                  ...
                  <li className="level1 green-link-section">
                    ...
                    <ul className="list-unstyled">
                      ...
                      <li className="level2">
                        <a href="https://wealthmanagement.adityabirlacapital.com/">
                          Wealth Management
                        </a>
                      </li>
                      <li className="level2">
                      ...
                      <li className="level2">
                        <a href="https://pensionfund.adityabirlacapital.com/">
                          Pension Funds{" "}
                        </a>
                      </li>
                      <li className="level2">
                        <a href="http://realestateinvestment.adityabirlacapital.com/">
                          Real Estate Investments{" "}
                        </a>
                      </li>
                    </ul>
                  ...
                  <li className="level1 yellow-link-section">
                    ...
                    <ul className="list-unstyled">
                      <li className="level2">
                        <a href="https://homefinance.adityabirlacapital.com/">
                          Home Finance{" "}
                        </a>
                      </li>
                      <li className="level2">
                        <a href="https://personalfinance.adityabirlacapital.com/">
                          Personal Finance
                        </a>
                      </li>
                      <li className="level2">
                        <a href="https://smefinance.adityabirlacapital.com/Pages/Individual/Products/Overview.aspx">
                          SME Finance{" "}
                        </a>
                      </li>
                      <li className="level2">
          ...
          <div className="navbarLinks">
            <div className="mobile-logo-section">
              ...
              <div className="utility-links-global-nav">
                <ul>
                  <li
                    id="personal-mobile-topmenu"
                    className={
                      globalMenuSelected === "personal" ? "selected-menu" : ""
                    }
                    onClick={() => setGlobalMenuSelected("personal")}
                  >
                    <NavLink to="#">Personal</NavLink>
                    <span></span>
                  </li>
                  <li
                    id="corporate-mobile-topmenu"
                    className={
                      globalMenuSelected === "corporates" ? "selected-menu" : ""
                    }
                    onClick={() => setGlobalMenuSelected("corporates")}
                  >
                    <NavLink to="#">Corporates</NavLink>
                    <span></span>
                  </li>
                  <li
                    id="advisor-mobile-topmenu"
                    className={
                      globalMenuSelected === "advisors" ? "selected-menu" : ""
                    }
                    onClick={() => setGlobalMenuSelected("advisors")}
                  >
              ...
              <div className="correction-div"></div>
            ...
            <ul className="navbar-nav mr-auto menu-ul">
              <li className="nav-item adv">
                <a
                  className="nav-link menu_label adv home"
                  href="https://www.adityabirlacapital.com/"
                >
                  Home
            ...
            <ul className="footer-links-wrapper">
              <li>
                <a
                  className="footer-link accordion collapsed"
                  href="#otherDropdownMenu"
                  data-toggle="collapse"
                  role="button"
                  aria-expanded="false"
                >
            ...
            <ul className="navbar-nav menu-ul right-menu-ul">
              ...
              <li className="nav-item">
                ...
                >
                  Home
                  <img className="right-img" alt="user.svg" src={user} />
                </NavLink> */}
              </li>
            </ul>
      ...
      <div className="container-fluid p-0">
        <div className="bs-pink-header">
          <div className="content-wrapper">
            <button type="button" className="life-insurance-btn">
              Life Insurance
            </button>
          </div>
        </div>
