...
import footerLogo from "./assets/img/images/footerlogo.png";
          ...
          <div className="upper-div">
            ...
            <div className="smcopyright">
              ...
              <div className="contacttext">
                ...
                <p className="caption">
                  <a href="tel:1800 270 7000" className="phone-link">
                    {" "}
                    1800 270 7000
                  </a>
                </p>
          ...
          <div className="lower-div">
            ...
            <div className="socialicons">
              ...
              <ul className="no-mar">
                <li className="">
                  <a
                    href="https://www.facebook.com/AdityaBirlaCapital/"
                    title=""
                ...
                <li className="">
                  <a
                    href="https://www.instagram.com/adityabirlacapital/"
                    title="Instagram"
                ...
                <li className="">
                  <a
                    href="https://www.linkedin.com/company/aditya-birla-capital"
                    title="Linked In"
                ...
                <li className="">
                  <a
                    href="https://twitter.com/abcapital"
                    title=""
                ...
                <li className="">
                  <a
                    href="https://www.youtube.com/channel/UCSki2tX_5kadIdz3m8Q4Fvg/"
                    title="Youtube"
