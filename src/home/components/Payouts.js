              ...
              <div className="row">
                <div className="col-md-12">
                  <ul>
                    ...
                    <li className="active-li">Payouts</li>
                  </ul>
                </div>
              </div>
            </div>
            ...
            <div className="row">
              ...
              {/*               <div className="col">
                <ul className="download-report">
                  <li>Export as:</li>
                  <li>
                    <img src={downloadexcel} alt="downloadxcel" />
                  </li>
                  <li>
                  ...
                  <div className="filter_body" id="style-3">
                    <div className="row">
                      ...
                      <div className="col-lg-12 filter_sub_check_box_row">
                        <h3>Type of Payout (Maturity,Survival,Claims,...)</h3>
                    ...
                    <div class="row">
                      <div class="col-lg-12 filter_sub_check_box_row">
                        <select class="custom-select custom-select-sm m-bottom-10">
                          ...
                          <option value="2">
                            Custom Date Range (Default - next 3 months)
                          </option>
                          ...
                          >
                            <li className="nav-item w-50-p" role="presentation">
                              <a
                                ...
                                aria-selected="true"
                              >
                                List of type of payouts to be provided filter
                              </a>
                            </li>
                            {/* <li className="nav-item w-50-p" role="presentation">
                              <a
