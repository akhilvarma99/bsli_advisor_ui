...
function customerdetailsaddfamily() {
  return (
    <div>
      <div>
        <Header />
              ...
              <div className="modal-dialog modal-width-family-tag">
                <div className="modal-content">
                  ...
                  <div className="modal-body moda-family-tag-body">
                    ...
                    {/* <div class="family-policy-details">
                <div class="row">
                  <div class="col-lg-3">
                    <p>Policy No. <br><label>123456789</label></p>
                  </div>
                  <div class="col-lg-4">
                    <p>Policy Holder Name <br><label>Rajesh Kanna</label></p>
                  </div>
                  <div class="col-lg-5">
                    <p>Plan Name  <br><label>Plan Name goes here</label></p>
                  </div>
                </div>
                <div class="row">
                  <div class="col-lg-12">
                ...
                <div class="row">
                  <div class="col-lg-4 col-md-5 col-12">
                    <div class="form-group">
                      <label for="exampleFormControlSelect1">Tag as</label>
                ...
                <div class="col-lg-12 text-right">
                  ...
                  <button class="btn btn-outline-s">Cancel</button> <button class="btn btn-primary">Add</button>
                </div>
              </div> */}
                  </div>
                </div>
...
export default customerdetailsaddfamily;
