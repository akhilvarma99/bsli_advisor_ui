...
function Password() {
          ...
          <div className="col-md-12">
            <div className="login-card shadow-sm">
              ...
              <div className="user-id-drop-div">
                <NavLink to="/users">{userID}</NavLink>{" "}
                  ...
                  <ul className="nav nav-tabs row" id="myTab" role="tablist">
                    <li className="nav-item col-6" role="presentation">
                      <span
                        className={
                          loginPassword
                            ? "nav-link active nav-link-50 cursor-pointer"
                            : "nav-link cursor-pointer  nav-link-50"
                        }
                        id="home-tab"
                        data-toggle="tab"
                        role="tab"
                  ...
                  <div className="tab-content" id="myTabContent">
                    ...
                    >
                      <div className="form-group">
                        ...
                        <input
                          className="form-control shadow-sm pass-auth"
                          id="password-field"
                          type="password"
                          name="password"
                        ...
                        <span
                          ...
                          onClick={() => {
                            const togglePwd = document.getElementById(
                              "toggle-pwd"
                            );
                    ...
                    <div
                      className={
                        loginOTP ? "tab-pane fade show active" : "tab-pane fade"
                      }
                      style={
                        loginOTP ? { display: "block" } : { display: "none" }
                      }
                      id="profile"
                      role="tabpanel"
                    ...
                    >
                      <div className="form-group">
                        <div
                          className="alert alert-secondary otp-txt mt-2"
                          style={
                            sendOTP ? { display: "block" } : { display: "none" }
                          }
                          role="alert"
                        >
                          Enter OTP sent to 98*****180 and san****ha@gmail.com
                          to continue
                        </div>
                        <br />
                        ...
                        <NavLink
                          to="#"
                          className="float-right link-underline"
                          onClick={(e) => {
                            e.preventDefault();
                            setSendOTP(true);
                          }}
                        ...
                        <label
                          className="otp-expire-txt"
                          style={
                            sendOTP ? { display: "block" } : { display: "none" }
                          }
                        >
                          Please wait for 60 seconds before requesting a new
  ...
  Launch static backdrop modal
      ...
      <div
        className={TermsModal ? `modal fade show` : "modal fade"}
        style={TermsModal ? { display: "block" } : { display: "none" }}
        id="staticBackdrop"
        ...
        <div className="modal-dialog">
          <div className="modal-content">
            ...
            <div className="modal-body">
              <p>
                You will be redirected to an external self-help page to reset
                your password. Click on OK to proceed.
              </p>
            </div>
            <div className="modal-footer">
              <button
